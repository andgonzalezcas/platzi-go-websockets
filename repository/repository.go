...
type Repository interface {
	...
	ListPosts(ctx context.Context, limit uint64, offset uint64) ([]models.Post, uint64, error)
	Close() error
}
...
func ListPosts(ctx context.Context, limit uint64, offset uint64) ([]models.Post, uint64, error) {
	return implementation.ListPosts(ctx, limit, offset)
}
