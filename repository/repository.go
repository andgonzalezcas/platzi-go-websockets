...
type Repository interface {
	...
	ListPosts(ctx context.Context, limit uint64, offset uint64) ([]models.Post, error)
	Close() error
}
...
func ListPosts(ctx context.Context, limit uint64, offset uint64) ([]models.Post, error) {
